// audiosystem_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module audiosystem_mm_interconnect_1 (
	...
	wire   [20:0] fifo_0_in_agent_m0_address;                               // fifo_0_in_agent:m0_address -> fifo_0_in_translator:uav_address
	...
	wire  [112:0] fifo_0_in_agent_rf_source_data;                           // fifo_0_in_agent:rf_source_data -> fifo_0_in_agent_rsp_fifo:in_data
	...
	wire  [112:0] fifo_0_in_agent_rsp_fifo_out_data;                        // fifo_0_in_agent_rsp_fifo:out_data -> fifo_0_in_agent:rf_sink_data
	...
	wire   [20:0] fifo_1_out_agent_m0_address;                              // fifo_1_out_agent:m0_address -> fifo_1_out_translator:uav_address
	...
	wire  [112:0] fifo_1_out_agent_rf_source_data;                          // fifo_1_out_agent:rf_source_data -> fifo_1_out_agent_rsp_fifo:in_data
	...
	wire  [112:0] fifo_1_out_agent_rsp_fifo_out_data;                       // fifo_1_out_agent_rsp_fifo:out_data -> fifo_1_out_agent:rf_sink_data
	...
	wire          fifo_1_out_agent_rdata_fifo_src_valid;                    // fifo_1_out_agent:rdata_fifo_src_valid -> fifo_1_out_agent_rdata_fifo:in_valid
	wire   [33:0] fifo_1_out_agent_rdata_fifo_src_data;                     // fifo_1_out_agent:rdata_fifo_src_data -> fifo_1_out_agent_rdata_fifo:in_data
	wire          fifo_1_out_agent_rdata_fifo_src_ready;                    // fifo_1_out_agent_rdata_fifo:in_ready -> fifo_1_out_agent:rdata_fifo_src_ready
	...
	wire  [111:0] fifo_0_in_agent_rp_data;                                  // fifo_0_in_agent:rp_data -> router_002:sink_data
	...
	wire          fifo_1_out_agent_rp_valid;                                // fifo_1_out_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] fifo_1_out_agent_rp_data;                                 // fifo_1_out_agent:rp_data -> router_003:sink_data
	wire          fifo_1_out_agent_rp_ready;                                // router_003:sink_ready -> fifo_1_out_agent:rp_ready
	wire          fifo_1_out_agent_rp_startofpacket;                        // fifo_1_out_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          fifo_1_out_agent_rp_endofpacket;                          // fifo_1_out_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> fifo_0_in_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // fifo_0_in_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> fifo_0_in_burst_adapter:sink0_channel
	...
	wire  [111:0] fifo_0_in_burst_adapter_source0_data;                     // fifo_0_in_burst_adapter:source0_data -> fifo_0_in_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> fifo_1_out_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> fifo_1_out_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // fifo_1_out_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> fifo_1_out_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> fifo_1_out_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> fifo_1_out_burst_adapter:sink0_endofpacket
	wire          fifo_1_out_burst_adapter_source0_valid;                   // fifo_1_out_burst_adapter:source0_valid -> fifo_1_out_agent:cp_valid
	wire  [111:0] fifo_1_out_burst_adapter_source0_data;                    // fifo_1_out_burst_adapter:source0_data -> fifo_1_out_agent:cp_data
	wire          fifo_1_out_burst_adapter_source0_ready;                   // fifo_1_out_agent:cp_ready -> fifo_1_out_burst_adapter:source0_ready
	wire    [1:0] fifo_1_out_burst_adapter_source0_channel;                 // fifo_1_out_burst_adapter:source0_channel -> fifo_1_out_agent:cp_channel
	wire          fifo_1_out_burst_adapter_source0_startofpacket;           // fifo_1_out_burst_adapter:source0_startofpacket -> fifo_1_out_agent:cp_startofpacket
	wire          fifo_1_out_burst_adapter_source0_endofpacket;             // fifo_1_out_burst_adapter:source0_endofpacket -> fifo_1_out_agent:cp_endofpacket
	...
	wire          fifo_1_out_agent_rdata_fifo_out_valid;                    // fifo_1_out_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] fifo_1_out_agent_rdata_fifo_out_data;                     // fifo_1_out_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          fifo_1_out_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_001:in_0_ready -> fifo_1_out_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> fifo_1_out_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> fifo_1_out_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // fifo_1_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> fifo_1_out_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (fifo_1_out_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (fifo_1_out_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (fifo_1_out_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (fifo_1_out_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (fifo_1_out_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (fifo_1_out_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) fifo_1_out_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                               //       clk.clk
		.reset             (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (fifo_1_out_agent_rdata_fifo_src_data),        //        in.data
		.in_valid          (fifo_1_out_agent_rdata_fifo_src_valid),       //          .valid
		.in_ready          (fifo_1_out_agent_rdata_fifo_src_ready),       //          .ready
		.out_data          (fifo_1_out_agent_rdata_fifo_out_data),        //       out.data
		.out_valid         (fifo_1_out_agent_rdata_fifo_out_valid),       //          .valid
		.out_ready         (fifo_1_out_agent_rdata_fifo_out_ready),       //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	audiosystem_mm_interconnect_1_router router (
	...
	audiosystem_mm_interconnect_1_router router_001 (
	...
	audiosystem_mm_interconnect_1_router_002 router_002 (
	...
	audiosystem_mm_interconnect_1_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (fifo_1_out_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (fifo_1_out_burst_adapter_source0_data),          //          .data
		.source0_channel       (fifo_1_out_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (fifo_1_out_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (fifo_1_out_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (fifo_1_out_burst_adapter_source0_ready)          //          .ready
	);

	audiosystem_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	audiosystem_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	audiosystem_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (fifo_0_reset_in_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiosystem_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (fifo_0_reset_in_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (fifo_1_out_agent_rdata_fifo_out_data),        //     in_0.data
		.in_0_valid     (fifo_1_out_agent_rdata_fifo_out_valid),       //         .valid
		.in_0_ready     (fifo_1_out_agent_rdata_fifo_out_ready),       //         .ready
